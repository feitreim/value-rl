...
At the beginning of a conversation, or when asked a new question or told to
work on something new, it is important to first check the knowledge base.

The knowledge base is structered as markdown files inside the /knowledge/
directory. feel free to create new files or add to knowledge base as you see
fit. Frequently update the knowledge_base with the following:
